...
@eventos_router.get('/Eventos/{nombre}', tags=['Eventos'], status_code=status.HTTP_200_OK,response_model=list[Eventos])
...
@eventos_router.get('/Eventos/descripcion/{descripcion}', tags=['Eventos'], status_code=status.HTTP_200_OK,response_model=list[Eventos])
...
@eventos_router.get('/Eventos/disponibles/{fecha}', tags=['Eventos'], status_code=status.HTTP_200_OK,response_model=list[Eventos])
...
@eventos_router.get('/Eventos/', tags=['Eventos'], status_code=status.HTTP_200_OK,response_model=list[Eventos])
def get_Eventos():
    db=Session()
