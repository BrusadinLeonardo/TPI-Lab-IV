...
@inscripciones_router.get('/inscripciones/{fecha}', tags=['inscripciones'], status_code=status.HTTP_200_OK,response_model=list[Inscripciones])
...
@inscripciones_router.get('/inscripciones/history/{usuario_id}', tags=['inscripciones'], status_code=status.HTTP_200_OK,response_model=list[Inscripciones])
...
@inscripciones_router.get('/inscripciones/', tags=['inscripciones'], status_code=status.HTTP_200_OK,response_model=list[Inscripciones])
